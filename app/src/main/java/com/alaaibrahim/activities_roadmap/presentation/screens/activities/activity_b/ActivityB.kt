...
class ActivityB : BaseActivity() {
    ...
    private fun setListeners() {
        ...
        findViewById<Button>(R.id.singleTaskBtn).setOnClickListener {
            val intent = SingleTaskActivity.getIntent(this)
            startActivity(intent)
        }

        findViewById<Button>(R.id.singleInstanceBtn).setOnClickListener {
            val intent = SingleInstanceActivity.getIntent(this)
            startActivity(intent)
        }

        findViewById<Button>(R.id.singleInstancePerTaskBtn).setOnClickListener {
